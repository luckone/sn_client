...
(function () {
  ...
  G.prototype.c = function (a) {
    for (var b = [], c = 0; c < arguments.length; c++) {
      b.push(arguments[c].replace(/[\W_]+/g, '')
        .toLowerCase());
    }
  ...
  function ga(a) {
    var b = 4,
      c = 'n',
      d = null;
    a && ((d = a.match(/(normal|oblique|italic)/i)) && d[1] && (c = d[1].substr(0, 1)
      .toLowerCase()), (d = a.match(/([1-9]00|normal|bold)/i)) && d[1] && (/bold/i.test(d[1]) ? b = 7 : /[1-9]00/.test(d[1]) && (b = parseInt(d[1].substr(0, 1), 10))));
    return c + b;
  };
  ...
  Q.prototype.start = function () {
    var a = this.c.m.document,
      ...
      d = new Promise(function (d, e) {
        function k() {
          q() - c >= b.f ? e() : a.fonts.load(fa(b.a), b.h)
            .then(function (a) {
  ...
  W.prototype.g = function (a) {
    var b = this.a;
    b.g && w(b.f, [b.a.c('wf', a.c, K(a)
      .toString(), 'active')], [b.a.c('wf', a.c, K(a)
      .toString(), 'loading'), b.a.c('wf', a.c, K(a)
      .toString(), 'inactive')]);
    L(b, 'fontactive', a);
    this.o = !0;
    oa(this);
  ...
  W.prototype.h = function (a) {
    var b = this.a;
    if (b.g) {
      var c = y(b.f, b.a.c('wf', a.c, K(a)
          .toString(), 'active')),
        d = [],
        e = [b.a.c('wf', a.c, K(a)
          .toString(), 'loading')];
      c || d.push(b.a.c('wf', a.c, K(a)
        .toString(), 'inactive'));
      w(b.f, d, e);
    }
    L(b, 'fontinactive', a);
